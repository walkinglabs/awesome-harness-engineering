...
- [forge-harness](https://github.com/chrono-meta/forge-harness) - A governance/quality harness for AI-assisted development: a 6-axis review framework with adversarial and source-grounding "quench" gates that bind verdicts to non-model evidence, targeting the design- and permission-level defect classes CI and type-checks structurally miss.
