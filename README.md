...
- [future-agi/traceAI](https://github.com/future-agi/traceAI) - Open-source OpenTelemetry-native tracing for LLM and agent harnesses; captures prompts, tool calls, retrieval steps, and long-running state across 50+ framework integrations in Python, TypeScript, Java, and C#, with no vendor lock-in.
- [future-agi/ai-evaluation](https://github.com/future-agi/ai-evaluation) - Open-source LLM evaluation library with 50+ metrics, LLM-as-judge, and guardrail scanners (jailbreak, PII, prompt-injection) for harness-time grading of agent traces, RAG outputs, and function-calling behavior.
