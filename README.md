...
- [future-agi/agent-opt](https://github.com/future-agi/agent-opt) - Open-source library for evaluation-driven prompt and agent-workflow optimization with six algorithms (Random, Bayesian, ProTeGi, Meta-Prompt, PromptWizard, GEPA), useful for tuning harness prompts against held-out task suites.
- [future-agi/simulate-sdk](https://github.com/future-agi/simulate-sdk) - Persona- and scenario-driven simulation SDK for voice and text agents, suitable for regression testing harness changes against multi-turn user behavior captured as transcripts and audio.
- [future-agi/future-agi](https://github.com/future-agi/future-agi) - Self-hostable open-source platform unifying tracing, evaluation, simulation, datasets, gateway, and guardrails into a single feedback loop for shipping self-improving agent harnesses.
