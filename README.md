...
- [codex-profiles](https://github.com/Ducksss/codex-profiles) - Codex CLI/Desktop profile launcher that maps each account or workflow context to an isolated `CODEX_HOME`, keeping auth, config, sessions, connectors, plugins, and logs separated for repeatable agent runs.
